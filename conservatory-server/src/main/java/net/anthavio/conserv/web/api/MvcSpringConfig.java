 ...
 */
@Configuration
@ComponentScan(value = "net.anthavio.conserv.web.api", excludeFilters = @ComponentScan.Filter(value = Configuration.class, type = FilterType.ANNOTATION))
@EnableWebMvc
public class MvcSpringConfig extends WebMvcConfigurerAdapter {
	...
	public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
		...
		try {
			...
			jaxb2Marshaller.setClassesToBeBound(net.anthavio.conserv.model.Config.class);
